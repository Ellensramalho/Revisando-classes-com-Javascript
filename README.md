# 📘 Exemplos de Classes e Conceitos em JavaScript

## 📌 Descrição

Este projeto reúne vários exemplos práticos para estudar e entender conceitos fundamentais de **JavaScript orientado a objetos**. 
...
* Praticar a sintaxe de classes no JavaScript.
* Entender como funcionam construtores, métodos e propriedades.
* Aprender a usar getters e setters para proteger e transformar dados.
* Compreender como funciona herança entre classes.
* Organizar melhor o código usando programação orientada a objetos.
